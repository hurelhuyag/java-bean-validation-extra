 ...
 * @see <a href="https://github.com/hibernate/hibernate-validator/blob/6.1/engine/src/main/java/org/hibernate/validator/constraints/SafeHtml.java">hibernate-validator</a> project
 */
@Documented
@Constraint(validatedBy = {SafeHtmlValidator.class})
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Repeatable(SafeHtml.List.class)
